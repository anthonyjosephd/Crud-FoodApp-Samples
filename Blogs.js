            ...
            <View style={styles.container}>

                {
                    this.props.loadingReducer ? <Text>Loading Please Wait</Text> : <FlatList style={{width:'100%'}}
                                                                                             ...
                                                                                             renderItem={({item}) => {
                                                                                                 return (
                                                                                                     <View style={{elevation:8, marginBottom:15,borderRadius:15, backgroundColor:'#e8a71a', padding:20}}>
                                                                                                         <Text style={{fontSize:28,  fontWeight:'bold', color:'#000000', marginBottom: 10,}} > {item.title}</Text>
